...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('/Users/admin/Downloads/E.D.I.T.H(The virtual assistant)/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
